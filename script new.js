...
// The application form uses FormSubmit's normal POST flow.
// Do not intercept the submission with fetch/AJAX: FormSubmit handles the
// email delivery and then redirects the applicant to _next (thank-you.html).
if(creatorForm){
